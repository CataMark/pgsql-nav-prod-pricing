select
    ...
    a."Old Value",
    a."New Value",
    e."Quantity per" as "Current Quantity per"
...
where a."Date and Time"::date between '2022-01-07'::date and '2022-01-10'::date and
    a."Table No_" = 5407 and a."Field No_" = 45 and
    a."Primary Key Field 1 Value" = '3' and a."Type of Change" = 1
