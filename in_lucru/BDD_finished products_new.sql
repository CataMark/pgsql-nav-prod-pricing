...
select
    a.*
from cte as a
where exists (select * from nav.tbl_int_item_ledger_entry as m where m."Posting Date" >= '2021-11-01'::date and m."Item No_" in (a."Kit No_", a."Item No_")) and
    not exists (select * from nav.tbl_int_item_ledger_entry as n where n."Posting Date" < '2021-11-01'::date and n."Item No_" in (a."Kit No_", a."Item No_"));